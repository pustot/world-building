...
庚二开 QLZ,庚二合 QFLZ,清A开 eLZ,清A合 vLZ,庚三开 QeLZ,庚三合 QvLZ 要不要全改成 -RZ 呢。。。方便发音，但是离后续的音变（以及现代发音嘛）更远.。。先不改了，因为清与阳冲突了现在。原因还是三等AB与C分得不开，或者说 d 直接与原本的通用合口器 F 构成开合口对了，导致接下来难搞。考不考虑引入 w 或者 s 来做 d 的合口？？？
